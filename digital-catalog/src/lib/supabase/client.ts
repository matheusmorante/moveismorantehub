...
// The public catalog loads the product list together with its images and
// variations. On slower mobile connections that legitimate request can take
// longer than 15 seconds, so aborting it made the storefront appear empty.
