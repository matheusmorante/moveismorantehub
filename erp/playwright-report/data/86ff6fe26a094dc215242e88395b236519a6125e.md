...
- Location: tests\e2e\products\products-variations-e2e.spec.ts:50:5
...
Locator: getByRole('button', { name: /novo produto|adicionar produto|\+ produto/i }).first()
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('button', { name: /novo produto|adicionar produto|\+ produto/i }).first() with timeout 10000ms
