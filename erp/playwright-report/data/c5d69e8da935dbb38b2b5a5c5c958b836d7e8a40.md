...
- Name: products\products-draft-flow.spec.ts >> Fluxo de Rascunho de Produto >> Caso 3: Produto concluído a partir de rascunho NÃO deve ter badge Rascunho
- Location: tests\e2e\products\products-draft-flow.spec.ts:238:5
