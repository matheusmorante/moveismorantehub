...
- Name: quick-register.spec.ts >> Cadastro Rápido de Produtos via NF-e (Modo A & Modo B) e Abas do Modal >> Modo A: Cadastro Rápido de Novo Produto Pai + Variação 1 com Categoria IA e Cor extraída
- Location: tests\e2e\assistant\cases\quick-register.spec.ts:47:5
