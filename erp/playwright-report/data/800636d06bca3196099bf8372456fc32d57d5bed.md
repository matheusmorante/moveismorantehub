...
- Name: products\reconciliation.spec.ts >> Supplier Reconciliation (Conciliação de Produtos) >> CT01: Should load the supplier reconciliation page without errors
- Location: tests\e2e\products\reconciliation.spec.ts:20:5
...
Locator: getByText('Conciliação de Fornecedores')
Expected: visible
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('Conciliação de Fornecedores') with timeout 10000ms
  - waiting for getByText('Conciliação de Fornecedores')
