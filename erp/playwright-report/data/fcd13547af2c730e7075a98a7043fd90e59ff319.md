...
- Name: products\reconciliation.spec.ts >> Supplier Reconciliation (Conciliação de Produtos) >> CT03: Should filter products by status
- Location: tests\e2e\products\reconciliation.spec.ts:45:5
...
Locator: getByText('Status da Pendência')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByText('Status da Pendência') with timeout 5000ms
  - waiting for getByText('Status da Pendência')
