...
- Name: products\compositions.spec.ts >> Módulo de Composições (Kit de Produtos) >> 3. UI/UX: Deve exibir o estado vazio "Composição vazia" quando não houver itens
- Location: tests\e2e\products\compositions.spec.ts:90:5
