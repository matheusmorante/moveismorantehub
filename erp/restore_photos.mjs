...
async function main() {
    ...
    const oldParentId = 'c0cda89f-8971-4146-bce7-0c4ead887f24'; // 000312
    const variationId = 'd0388a28-79f9-4d68-9be5-fe2bda5641ef'; // Capuccino/Terracota

    // 1. Obter as imagens do antigo pai
    ...
    console.log('Images to restore:', imageUrls);

    // 2. Atualizar a variação com essas fotos
    ...
    // 3. Atualizar a tabela product_images do pai atual (000314)
    ...
    // 4. Atualizar a coluna products.images (somar as novas com as antigas)
