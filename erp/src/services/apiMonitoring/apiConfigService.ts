...
export const DEFAULT_API_CONFIGURATIONS: Record<ApiServiceId, ApiConfiguration> = {
    ...
    gemini_flash: {
        ...
        provider: 'gemini',
        service_name: 'Google Gemini 1.5/2.5 Flash',
        metric: 'requests',
        billing_unit: 'req',
        monthly_limit: 3000,
        warning_threshold: 70,
        ...
        free_allowance: 100,
        currency: 'BRL',
        max_monthly_budget_brl: 30.00, // Teto máximo absoluto de R$ 30,00 por mês
        circuit_breaker_max_per_minute: 60,
        enabled: true,
    },
    gemini_antigravity: {
        service_id: 'gemini_antigravity',
        provider: 'gemini',
        service_name: 'Google Gemini Antigravity / AI Agent',
        metric: 'requests',
        billing_unit: 'req',
        monthly_limit: 3000,
        warning_threshold: 70,
    ...
    gemini_image: {
        service_id: 'gemini_image',
        provider: 'gemini',
        service_name: 'Google Gemini Imagem (Marketing & Posts)',
        metric: 'images',
        billing_unit: 'img',
        monthly_limit: 150,
        warning_threshold: 70,
        ...
        free_allowance: 10,
        currency: 'BRL',
        max_monthly_budget_brl: 30.00,
        circuit_breaker_max_per_minute: 5,
        enabled: true,
    },
    gemini_tts: {
        service_id: 'gemini_tts',
        provider: 'gemini',
        service_name: 'Google Gemini Voz / Áudio TTS',
        metric: 'characters',
        billing_unit: 'chars',
        monthly_limit: 50000,
        warning_threshold: 70,
        ...
        free_allowance: 5000,
        currency: 'BRL',
        max_monthly_budget_brl: 15.00,
        circuit_breaker_max_per_minute: 30,
        enabled: true,
    },
    meta_whatsapp: {
