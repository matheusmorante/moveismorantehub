...
const SupplierAutocomplete: React.FC<SupplierAutocompleteProps> = ({
    ...
    // Filtrar sugestões localmente (ou mostrar todos quando focado com query vazia ou pequena)
    ...
    return (
        <div ref={wrapperRef} className={`relative flex flex-col gap-2 ${className}`}>
            ...
            <DropdownPortal anchorRef={wrapperRef} isOpen={!disabled && showSuggestions && suppliers.length > 0}>
