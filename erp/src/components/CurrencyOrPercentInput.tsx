    ...
    if (showBadge) {
        ...
        return (
            <div className="flex w-full items-center border-b-2 border-slate-200 bg-transparent transition-colors focus-within:border-blue-600 dark:border-slate-700 dark:focus-within:border-blue-500">
                ...
                />
                {!isLeftBadge && (
                    <div className="bg-transparent text-blue-700 dark:text-blue-300 font-black text-[10px] uppercase tracking-wider pl-1.5 pr-1 py-2 flex items-center justify-center shrink-0 self-stretch">
                        {displayBadge}
                    </div>
                )}
            </div>
