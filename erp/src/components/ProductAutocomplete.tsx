            ...
            <div className="flex gap-1.5">
                <div className="relative flex-1">
                    <input
                        ...
                        className={inputClassName || `w-full px-2 py-2 bg-transparent border-0 border-b-2 rounded-none outline-none transition-all text-sm font-bold shadow-none ${
                            isTemporary 
                                ? 'border-amber-400 text-amber-950 dark:text-amber-100 focus:border-amber-500 focus:ring-0' 
                                : isSelected 
                                    ? 'border-emerald-500 text-emerald-950 dark:text-emerald-100 font-semibold focus:border-emerald-600 focus:ring-0 pr-8'
                                    : 'border-slate-300 dark:border-slate-700 hover:border-slate-400 dark:hover:border-slate-600 focus:border-blue-600 dark:focus:border-blue-500 focus:ring-0'
                        } ${className}`}
                    />
                    {isLoading ? (
