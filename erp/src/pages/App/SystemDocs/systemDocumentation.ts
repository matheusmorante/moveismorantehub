...
export const systemDocumentation: DocumentationSection[] = [
    ...
    },
    {
        ...
        flow: [{ title: "Rascunho", detail: "Preenchimento sem saída de estoque." }, { title: "Agendado", detail: "Agenda e baixa configurada são acionadas." }, { title: "Atendido", detail: "Venda concluída; devolução pode ser criada." }, { title: "Devolução atendida", detail: "Após confirmação de cinco segundos, cria entrada e fica definitiva." }],
    },
    {
        title: "Orçamentos",
        ...
        rules: [
            ...
            "Ao gerar um pedido de venda a partir do orçamento, nasce um novo pedido; os gatilhos de estoque e da agenda passam a valer somente para essa venda.",
        ],
    ...
    },
    {
        ...
        rules: [
            "A agenda pode exibir assistências agendadas conforme tipo e período selecionados.",
        ...
        flow: [{ title: "Abrir assistência", detail: "Registra serviço e itens associados." }, { title: "Agendar", detail: "Entra na agenda conforme período e tipo." }, { title: "Executar", detail: "Segue fluxo próprio, sem baixa automática de venda." }],
    },
    {
        title: "Produtos e estoque",
        icon: "bi-lightning-charge-fill",
        summary: "Cada mudança de status afeta, de forma independente, o estoque, as movimentações e a agenda. Produtos físicos são sempre variações; produto pai não recebe saldo.",
        rules: [
    ...
    },
    {
        ...
        summary: "A agenda operacional apresenta pedidos com agendamento preenchido, obedecendo data e filtros de período ativos.",
        rules: [
            "Rascunho com data ou agendamento preenchido aparece para planejamento, mas não faz movimentação de estoque.",
            "Pedidos agendados aparecem na agenda; atendidos e cancelados não aparecem.",
            "Ao desfazer atendimento, o pedido pode voltar à agenda se sua data estiver dentro do filtro.",
        ],
