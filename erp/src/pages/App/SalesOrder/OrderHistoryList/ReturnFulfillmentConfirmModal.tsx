    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/60 p-4" role="dialog" aria-modal="true">
            <section className="w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-900">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-600 dark:text-slate-300">Ao atender este pedido de devolução, uma movimentação de entrada será gerada para os itens devolvidos. Depois disso, esta devolução não poderá ser cancelada ou desfeita. Caso seja necessário corrigir a operação, gere um novo pedido de venda.</p>
