...
export const InboundInvoicesPagination: React.FC<InboundInvoicesPaginationProps> = ({
    ...
    return (
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 px-4 sm:px-6 bg-slate-50/70 dark:bg-slate-900/40 rounded-2xl border border-slate-200/70 dark:border-slate-800/80 shadow-sm mt-4 mb-2">
