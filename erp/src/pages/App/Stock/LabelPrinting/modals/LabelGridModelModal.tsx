                ...
                <div className="px-12 py-8 border-b border-slate-50 dark:border-slate-800 bg-white dark:bg-slate-900 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-5">
                        ...
                        <div> 
                            ...
                            <h3 id="label-grid-modal-title" className="text-2xl font-black text-slate-800 dark:text-white uppercase tracking-tighter leading-none">{name.trim() || generatedName}</h3> 
                        </div>
                    </div>
