...
export interface ReceiptActionButtonsProps {
...
/**
 * Menu dropdown de ações para recebimento de mercadoria (manual, via NF-e ou via Pedido de Compra).
 */
        ...
        <div className="relative inline-flex" ref={dropdownRef}>
            <div className="relative w-full sm:w-auto">
                <button
                    ...
                    aria-haspopup="menu"
                    aria-label="Abrir opções de recebimento de mercadoria"
                    className="inline-flex w-full items-center justify-between gap-2 rounded-xl bg-emerald-600 px-4 py-2.5 text-xs font-black uppercase tracking-wider text-white shadow-md hover:bg-emerald-700 transition-colors sm:w-auto cursor-pointer"
                >
                ...
                {isMenuOpen && (
                    <div
                        ...
                        className="absolute right-0 top-full z-50 mt-2 w-full min-w-[19rem] rounded-2xl border border-slate-100 bg-white p-2 shadow-xl animate-in fade-in dark:border-slate-800 dark:bg-slate-900 space-y-1"
                    >
                        <button
                            type="button"
                            role="menuitem"
                            onClick={() => { handleClose(); onSelectManual(); }}
                            className="flex w-full items-center gap-3 rounded-xl p-2.5 text-left text-xs font-bold text-emerald-700 hover:bg-emerald-50 dark:text-emerald-300 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                        >
                        ...
                        <button
                            type="button"
                            role="menuitem"
                            onClick={() => { handleClose(); onSelectInboundNfe(); }}
                            className="flex w-full items-center gap-3 rounded-xl p-2.5 text-left text-xs font-bold text-indigo-700 hover:bg-indigo-50 dark:text-indigo-300 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                        >
                        ...
                        <button
                            type="button"
                            role="menuitem"
                            onClick={() => { handleClose(); onSelectPurchase(); }}
                            className="flex w-full items-center gap-3 rounded-xl p-2.5 text-left text-xs font-bold text-blue-700 hover:bg-blue-50 dark:text-blue-300 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                        >
