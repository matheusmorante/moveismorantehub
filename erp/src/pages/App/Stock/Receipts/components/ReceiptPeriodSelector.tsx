...
import { ReceiptPeriod, RECEIPT_PERIOD_OPTIONS } from '../types/receiptPeriodFilter.types';

export interface ReceiptPeriodSelectorProps {
...
/**
 * Seletor de período temporal pré-definido e personalizado para listagem de recebimentos.
 */
