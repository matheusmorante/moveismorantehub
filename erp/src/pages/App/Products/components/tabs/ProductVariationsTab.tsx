...
interface Props {
    ...
    editingVariationComboId?: string | null;
    setEditingVariationComboId?: (id: string | null) => void;
    editingVariationId?: string | null;
    setEditingVariationId?: (id: string | null) => void;
}

const ProductVariationsTab: React.FC<Props> = ({
    formData,
