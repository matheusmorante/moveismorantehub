...
export const isSampleInvoice = (inv: { id?: string; nfeKey?: string; nfeNumber?: string; emitterCnpj?: string }) => {
    return inv.id === 'inbound_41260944512248000107550010000012341000012345' ||
        ...
        (String(inv.nfeNumber) === '1234' && inv.emitterCnpj === '12.345.678/0001-90');
};
