...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 19 — Modal de Ambiente não exibe seção de Atributos Obrigatórios
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:731:5
