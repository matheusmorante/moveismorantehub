...
- Name: assistant\cases\assistant-despesas.spec.ts >> Assistente Financeiro — Suíte E2E Determinística >> E2E determinístico: complemento de pagamento para despesa sem valor
- Location: tests\e2e\assistant\cases\assistant-despesas.spec.ts:125:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:20 PM
