...
- Name: stock\stock-receipts.spec.ts >> Módulo de Estoque - Recebimentos de Mercadorias e Ciclo de Estorno >> 3. Validação dos Badges de Status e Movimentação na tabela de recebimentos
- Location: tests\e2e\stock\stock-receipts.spec.ts:115:5
...
Locator: locator('text=/Nenhum recebimento encontrado/i')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('text=/Nenhum recebimento encontrado/i') with timeout 5000ms
  - waiting for locator('text=/Nenhum recebimento encontrado/i')
