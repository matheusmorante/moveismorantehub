...
- Name: stock\label-printing.spec.ts >> Suíte E2E B2B - Módulo de Etiquetas (Label Printing) >> Cenário 2: Troca de Categorias de Etiqueta (Tabs)
- Location: tests\e2e\stock\label-printing.spec.ts:80:5
...
Call log:
  - waiting for locator('button:has-text("Etiquetas de Preço")')
      ...
      - generic [ref=e5]:
        - generic [ref=e7]:
          - generic [ref=e8]:
            - generic [ref=e9]: 
            - generic [ref=e11]:
              - heading "Etiquetas de Logotipo e Rótulo" [level=1] [ref=e12]
              - generic [ref=e13]:
                - generic [ref=e14]: "Modelo: 4 Etiquetas (Retangular) (2x2)"
                - generic [ref=e15]: •
                - generic [ref=e16]: Folha A4
          - button "" [ref=e19] [cursor=pointer]
        - generic [ref=e21]:
          - generic [ref=e22]:
            - generic [ref=e24]:
              - generic [ref=e25]:
                - heading "Gerenciar Etiquetas" [level=3] [ref=e26]
                - paragraph [ref=e27]: Organize e configure seus ativos para impressão
              - button " Biblioteca" [ref=e29] [cursor=pointer]:
                - generic [ref=e30]: 
                - text: Biblioteca
            - generic [ref=e34]:
              - generic [ref=e35]: 
              - paragraph [ref=e36]: Nenhuma etiqueta adicionada
              - paragraph [ref=e37]: Busque um produto acima para começar a montar a impressão.
          - generic [ref=e39]:
            - heading "Preview" [level=3] [ref=e40]
            - generic [ref=e41]:
              - button "Página anterior" [disabled] [ref=e42]:
                - generic [ref=e43]: 
              - generic [ref=e44]: 1/1
              - button "Próxima página" [disabled] [ref=e45]:
                - generic [ref=e46]: 
              - button "Diminuir zoom" [ref=e48] [cursor=pointer]:
                - generic [ref=e49]: 
              - generic [ref=e50]: 60%
              - button "Aumentar zoom" [ref=e51] [cursor=pointer]:
                - generic [ref=e52]: 
            - button "Ações do preview" [ref=e54] [cursor=pointer]:
              - generic [ref=e55]: 
    - generic [ref=e66]:
      - generic:
        - generic:
      ...
      - button "Abrir chat do Seu Lizandro, Agente Inteligente do ERP" [ref=e67] [cursor=pointer]:
        - img "Seu Lizandro - Agente IA" [ref=e69]
  - region "Notifications Alt+T"
```
