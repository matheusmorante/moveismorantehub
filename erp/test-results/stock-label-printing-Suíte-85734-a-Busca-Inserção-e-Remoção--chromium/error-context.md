...
- Name: stock\label-printing.spec.ts >> Suíte E2E B2B - Módulo de Etiquetas (Label Printing) >> Cenário 3 e 4: Interação com a Fila (Busca, Inserção e Remoção)
- Location: tests\e2e\stock\label-printing.spec.ts:97:5
