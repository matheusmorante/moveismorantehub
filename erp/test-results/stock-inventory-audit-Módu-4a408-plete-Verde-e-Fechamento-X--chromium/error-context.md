...
- Name: stock\inventory-audit.spec.ts >> Módulo de Estoque - Inventário e Auditoria >> 2. Inventário Personalizado: Adição Dinâmica, Autocomplete Verde, e Fechamento (X)
- Location: tests\e2e\stock\inventory-audit.spec.ts:110:5
...
Call log:
  - waiting for locator('button:has-text("Personalizado")')
