...
- Name: products\compositions.spec.ts >> Módulo de Composições (Kit de Produtos) >> 2. Validação: Não deve permitir salvar composição sem nome
- Location: tests\e2e\products\compositions.spec.ts:69:5
