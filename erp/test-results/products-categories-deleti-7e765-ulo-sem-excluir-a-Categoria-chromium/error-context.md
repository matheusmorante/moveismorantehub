...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 5 — Desvincular Categoria de Ambiente remove vínculo sem excluir a Categoria
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:435:5
...
Call log:
  - waiting for locator('div[data-testid^="environment-row-env-sala"]').locator('span:has-text("PUFE COM AMBIENTES SEM PRODUTOS")').locator('button[title*="Desvincular"]')
