...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 7 — Exclusão de Ambiente permitida quando vazio (0 categorias)
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:484:5
...
Locator: locator('div[data-testid^="environment-row-env-varanda"]')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('div[data-testid^="environment-row-env-varanda"]') with timeout 5000ms
  - waiting for locator('div[data-testid^="environment-row-env-varanda"]')
