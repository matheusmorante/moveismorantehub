...
- Location: tests\e2e\products\products-variations-e2e.spec.ts:161:5
...
+   "[hmr] Failed to reload /src/pages/App/Products/components/VariationRow.tsx. This could be due to syntax errors or importing non-existent modules. (see errors above)",
+ ]
```
