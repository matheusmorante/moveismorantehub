...
- Name: orders\order-normalization.spec.ts >> Auditoria E2E via Browser - Normalização de Pedidos Morante Hub >> Cenário 1: Fluxo Real no Navegador - Criação de Pedido via UI e Gravação Atômica nas Tabelas Normalizadas
