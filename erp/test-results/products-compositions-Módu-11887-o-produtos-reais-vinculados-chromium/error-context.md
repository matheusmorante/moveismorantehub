...
- generic [ref=f2e2]:
  - generic [ref=f2e3]:
    ...
    - main [ref=f2e4]:
      - generic [ref=f2e7]:
        - generic [ref=f2e9]:
          - generic [ref=f2e10]:
            - generic [ref=f2e11]: 
            - textbox "Pesquisar composições..." [ref=f2e12]
          - button "" [ref=f2e15] [cursor=pointer]
        - generic [ref=f2e17]:
          - generic [ref=f2e20]:
            - button " Mostrar desativados" [ref=f2e22] [cursor=pointer]:
              - generic [ref=f2e23]: 
              - text: Mostrar desativados
            - generic [ref=f2e24]:
              - text:                   
              - button " Variações (2) 000001-COMP Status ERP derivado das variações  Última Unidade - Mostruário Editar Produto Opções do produto Cozinha Modulada Florença 6 Peças 100% MDF Cozinhas Moduladas e Compactas •  Móveis Sul" [ref=f2e26] [cursor=pointer]:
                - generic [ref=f2e27]:
                  - generic [ref=f2e28]:
                    - button " Variações (2)" [ref=f2e29]:
                      - generic [ref=f2e30]: 
                      - generic [ref=f2e31]: Variações (2)
                    - generic [ref=f2e32]: 000001-COMP
                  - generic [ref=f2e33]:
                    - generic "Status ERP derivado das variações" [ref=f2e35]:
                      - generic [ref=f2e36]:
                        - generic [ref=f2e37]: ERP
                        - generic [ref=f2e38]: Ativo
                    - generic [ref=f2e41]:
                      - generic [ref=f2e42]: 
                      - text: Última Unidade - Mostruário
                    - generic [ref=f2e43]:
                      - button "Editar Produto" [ref=f2e44]:
                        - generic [ref=f2e45]: 
                      - button "Opções do produto" [ref=f2e46]:
                        - generic [ref=f2e47]: 
                - generic [ref=f2e49]:
                  - heading "Cozinha Modulada Florença 6 Peças 100% MDF" [level=3] [ref=f2e50]
                  - generic [ref=f2e51]:
                    - generic [ref=f2e52]: Cozinhas Moduladas e Compactas
                    - generic [ref=f2e53]: •
                    - generic [ref=f2e54]:
                      - generic [ref=f2e55]: 
                      - text: Móveis Sul
            - generic [ref=f2e56]:
              - generic [ref=f2e57]:
                - generic [ref=f2e58]: Página 1 · 1 itens no catálogo
                - combobox [ref=f2e60]:
                  - option "10 por página"
                  - option "15 por página" [selected]
              - generic [ref=f2e61]:
                - button "" [disabled] [ref=f2e62]
                - button "1" [disabled] [ref=f2e66]
                - button "" [disabled] [ref=f2e68]
          - generic [ref=f2e70]:
            - generic [ref=f2e71]:
              - button " Resumo das Composições " [ref=f2e72] [cursor=pointer]:
                - generic [ref=f2e73]:
                  - generic [ref=f2e74]: 
                  - heading "Resumo das Composições" [level=4] [ref=f2e76]
                - generic [ref=f2e77]: 
              - generic [ref=f2e78]:
                - button " Total de Cadastrados 297" [ref=f2e79] [cursor=pointer]:
                  - generic [ref=f2e80]:
                    - generic [ref=f2e81]: 
                    - generic [ref=f2e82]: Total de Cadastrados
                  - generic [ref=f2e83]: "297"
                - generic [ref=f2e84]:
                  - button "Publicados 170" [ref=f2e85] [cursor=pointer]:
                    - generic [ref=f2e86]: Publicados
                    - generic [ref=f2e87]: "170"
                  - button "Desativados 22" [ref=f2e88] [cursor=pointer]:
                    - generic [ref=f2e89]: Desativados
                    - generic [ref=f2e90]: "22"
                  - button " Rascunhos (Em Cadastro) 0" [ref=f2e91] [cursor=pointer]:
                    - generic [ref=f2e92]:
                      - generic [ref=f2e93]: 
                      - generic [ref=f2e94]: Rascunhos (Em Cadastro)
                    - generic [ref=f2e95]: "0"
            - generic [ref=f2e96]:
              - button " Filtros " [ref=f2e97] [cursor=pointer]:
                - generic [ref=f2e98]:
                  - generic [ref=f2e99]: 
                  - heading "Filtros" [level=4] [ref=f2e101]
                - generic [ref=f2e102]: 
              - complementary "Filtros de produtos" [ref=f2e104]:
                - generic [ref=f2e105]:
                  - generic [ref=f2e106]: Parâmetros
                  - generic [ref=f2e108]:
                    - generic [ref=f2e109]:
                      - generic [ref=f2e110]: Categoria
                      - combobox "Categoria" [ref=f2e111] [cursor=pointer]:
                        ...
                        - option "Treliches"
                    - generic [ref=f2e112]:
                      - generic [ref=f2e113]: Situação no ERP
                      - combobox "Situação no ERP" [ref=f2e114] [cursor=pointer]:
                        - option "Todos os Produtos" [selected]
                        - option "Produtos Ativos"
                        - option "Produtos Desativados"
                        - option "Rascunhos (Em Cadastro)"
                    - generic [ref=f2e115]:
                      - generic [ref=f2e116]: Catálogo Digital
                      - combobox "Catálogo Digital" [ref=f2e117] [cursor=pointer]:
                        - option "Todos" [selected]
                        - option "Publicado no Catálogo"
                        - option "Ocultado do Catálogo"
                - button "Limpar Filtros" [ref=f2e119] [cursor=pointer]:
    ...
    - generic [ref=f2e122]:
      ...
      - button "Abrir chat do Seu Lizandro, Agente Inteligente do ERP" [ref=f2e123] [cursor=pointer]:
        - img "Seu Lizandro - Agente IA" [ref=f2e125]
  - region "Notifications Alt+T"
```
