...
- Name: stock\stock-purchases.spec.ts >> Módulo de Estoque - Pedidos de Compra >> 1. Renderização da tela de Pedidos de Compra com cabeçalho e botão Nova Compra
- Location: tests\e2e\stock\stock-purchases.spec.ts:48:5
...
Locator: locator('h1:has-text("Pedidos de Compra")')
Expected: visible
Timeout: 15000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('h1:has-text("Pedidos de Compra")') with timeout 15000ms
  - waiting for locator('h1:has-text("Pedidos de Compra")')
