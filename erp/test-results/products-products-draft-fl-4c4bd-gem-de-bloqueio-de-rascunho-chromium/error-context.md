...
- Name: products\products-draft-flow.spec.ts >> Fluxo de Rascunho de Produto >> Caso 5: Produto cadastrado (ex-rascunho) não exibe mensagem de bloqueio de rascunho
- Location: tests\e2e\products\products-draft-flow.spec.ts:289:5
    ...
    - main [ref=f1e4]:
      - generic [ref=f1e7]:
        ...
        - generic [ref=f1e17]:
          ...
          - generic [ref=f1e25]:
            - generic [ref=f1e26]:
              - button " Resumo dos Produtos " [ref=f1e27] [cursor=pointer]:
                - generic [ref=f1e28]:
                  - generic [ref=f1e29]: 
                  - heading "Resumo dos Produtos" [level=4] [ref=f1e31]
                - generic [ref=f1e32]: 
              - generic [ref=f1e33]:
