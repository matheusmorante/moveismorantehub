...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 12 — Filtros de Categoria (Todas, Com ambiente, Sem ambiente)
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:598:5
