...
- Name: assistant\cases\assistant-edit.spec.ts >> Assistente Financeiro - Edição e Alteração >> Edição de compra informando fornecedor
- Location: tests\e2e\assistant\cases\assistant-edit.spec.ts:14:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:21 PM
