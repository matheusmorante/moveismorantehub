...
- Name: orders\order-normalization.spec.ts >> Auditoria E2E via Browser - Normalização de Pedidos Morante Hub >> Cenário 2: Fluxo Real no Navegador - Edição do Pedido via UI sem Orfandade nem Duplicações
...
- main:
  ...
  - button ""
  - text:  Data do Pedido
  - textbox: 2026-09-26T13:30
  - text: Total do Pedido R$ 0,00 Sincronizando...
