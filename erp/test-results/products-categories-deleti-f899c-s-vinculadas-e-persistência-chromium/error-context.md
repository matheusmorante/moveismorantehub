...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 13 — Editar Ambiente: nome, categorias vinculadas e persistência
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:620:5
...
Call log:
  - waiting for locator('div[data-testid^="environment-row-env-sala"]').locator('button[aria-label*="Editar ambiente"]')
