...
- Name: assistant\cases\assistant-create.spec.ts >> Assistente Financeiro - Criação de Lançamentos >> Criação de saída simples em dinheiro
- Location: tests\e2e\assistant\cases\assistant-create.spec.ts:14:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:16 PM
