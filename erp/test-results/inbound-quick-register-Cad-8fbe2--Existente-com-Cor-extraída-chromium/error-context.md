...
- Name: inbound\quick-register.spec.ts >> Cadastro Rápido de Produtos via NF-e (Modo A & Modo B) e Abas do Modal >> Modo B: Cadastro Rápido de Variação em Produto Pai Existente com Cor extraída
- Location: tests\e2e\inbound\quick-register.spec.ts:57:5
