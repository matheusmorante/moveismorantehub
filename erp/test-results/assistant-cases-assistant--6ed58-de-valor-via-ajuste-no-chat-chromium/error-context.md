...
- Name: assistant\cases\assistant-despesas.spec.ts >> Assistente Financeiro — Suíte E2E Determinística >> E2E determinístico: correção de valor via ajuste no chat
- Location: tests\e2e\assistant\cases\assistant-despesas.spec.ts:102:3
