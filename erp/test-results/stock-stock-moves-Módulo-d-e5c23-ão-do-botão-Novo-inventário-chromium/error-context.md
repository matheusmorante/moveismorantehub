...
- Name: stock\stock-moves.spec.ts >> Módulo de Estoque - Movimentações, Histórico e Inventário >> 2. Alternância de abas para Inventários (/stock?tab=audit) e exibição do botão Novo inventário
- Location: tests\e2e\stock\stock-moves.spec.ts:72:5
...
- Array []
+ Array [
+   "[hmr] Failed to reload /src/pages/App/SalesOrder/OrderHistoryList/OrderHistoryRow.tsx. This could be due to syntax errors or importing non-existent modules. (see errors above)",
+ ]
```
