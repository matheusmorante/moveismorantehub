...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 17 — Responsividade em Desktop, Tablet e Mobile (cards sem scroll horizontal)
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:695:5
...
Locator: locator('h1:has-text("Ambientes e Categorias")')
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('h1:has-text("Ambientes e Categorias")') with timeout 5000ms
  - waiting for locator('h1:has-text("Ambientes e Categorias")')
