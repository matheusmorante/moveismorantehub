...
- Name: assistant\cases\assistant-despesas.spec.ts >> Assistente Financeiro — Suíte E2E Determinística >> E2E determinístico: resposta simples e exibição de card de preview
- Location: tests\e2e\assistant\cases\assistant-despesas.spec.ts:45:3
...
Call log:
  ...
  - waiting for locator('[data-testid="assistant-input"]')
    - waiting for "http://localhost:5173/?auth_email=matheusmorante002@gmail.com&user_id=mock-e2e-master&auth_role=administrator" navigation to finish...
    - navigated to "http://localhost:5173/?auth_email=matheusmorante002@gmail.com&user_id=mock-e2e-master&auth_role=administrator"
