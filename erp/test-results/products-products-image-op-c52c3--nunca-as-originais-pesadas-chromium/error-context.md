...
- Name: products\products-image-optimization.spec.ts >> Otimização de Imagens de Produtos (Egress Guard) >> Garante que a listagem de produtos só carrega miniaturas (thumb.webp) e nunca as originais pesadas
- Location: tests\e2e\products\products-image-optimization.spec.ts:5:3
