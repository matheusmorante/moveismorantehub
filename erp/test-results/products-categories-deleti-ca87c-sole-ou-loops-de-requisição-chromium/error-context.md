...
- Name: products\categories-deletion-safety.spec.ts >> Suíte Permanente E2E: Ambientes e Categorias >> Cenário 18 — Fluxo completo sem erros críticos no console ou loops de requisição
- Location: tests\e2e\products\categories-deletion-safety.spec.ts:717:5
