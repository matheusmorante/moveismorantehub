...
- Name: assistant\cases\assistant-errors.spec.ts >> Assistente Financeiro - Validação e Alertas de Divergência >> Detecta divergência entre total informado e soma das parcelas
- Location: tests\e2e\assistant\cases\assistant-errors.spec.ts:14:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:22 PM
