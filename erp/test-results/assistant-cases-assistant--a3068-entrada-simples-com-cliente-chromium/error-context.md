...
- Name: assistant\cases\assistant-create.spec.ts >> Assistente Financeiro - Criação de Lançamentos >> Criação de entrada simples com cliente
- Location: tests\e2e\assistant\cases\assistant-create.spec.ts:21:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:17 PM
