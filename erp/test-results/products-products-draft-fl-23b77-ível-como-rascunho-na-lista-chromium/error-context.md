...
- Name: products\products-draft-flow.spec.ts >> Fluxo de Rascunho de Produto >> Caso 1: Salvar rascunho — produto fica visível como rascunho na lista
- Location: tests\e2e\products\products-draft-flow.spec.ts:183:5
