...
- Name: assistant\cases\assistant-real-ai.spec.ts >> Assistente Financeiro — Smoke Test com IA Real (Gemini Live) >> IA REAL: Interpretação de despesa e captura de resposta bruta
- Location: tests\e2e\assistant\cases\assistant-real-ai.spec.ts:46:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:24 PM
