...
- Name: assistant\cases\assistant-dates.spec.ts >> Assistente Financeiro - Tratamento de Datas Relativas >> Vencimento todo dia 20 a partir do próximo mês
- Location: tests\e2e\assistant\cases\assistant-dates.spec.ts:14:3
...
- banner:
  ...
  - button ""
- img "seu Lizandro"
- text: Olá! Sou Seu Lizandro, seu Agente Inteligente do ERP. Posso lançar despesas, receitas, consultar o fluxo de caixa ou tirar dúvidas do sistema. Como posso te ajudar hoje? 01:18 PM
