...
- Name: stock\label-printing.spec.ts >> Suíte E2E B2B - Módulo de Etiquetas (Label Printing) >> Cenário 5: Menu Suspenso e Modo Avançado (Etiquetas de Preço)
- Location: tests\e2e\stock\label-printing.spec.ts:130:5
...
Call log:
  - waiting for locator('button:has-text("Etiquetas de Preço")')
    - waiting for "http://localhost:5173/estoque/etiquetas?auth_email=matheusmorante002@gmail.com&user_id=mock-e2e-master&auth_role=administrator" navigation to finish...
    - navigated to "http://localhost:5173/estoque/etiquetas?auth_email=matheusmorante002@gmail.com&user_id=mock-e2e-master&auth_role=administrator"
