...
- Name: stock\stock-receipts.spec.ts >> Módulo de Estoque - Recebimentos de Mercadorias e Ciclo de Estorno >> 1. Renderização da página /stock/receipts com cabeçalho e filtros operacionais
- Location: tests\e2e\stock\stock-receipts.spec.ts:72:5
...
Locator: locator('h1:has-text("Recebimentos de Mercadorias")')
Expected: visible
Timeout: 15000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" locator('h1:has-text("Recebimentos de Mercadorias")') with timeout 15000ms
  - waiting for locator('h1:has-text("Recebimentos de Mercadorias")')
