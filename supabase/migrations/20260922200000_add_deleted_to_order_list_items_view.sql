-- Expose the soft-delete state to the mobile order cache without changing its row set.
-- Appending the column keeps this view replacement compatible with existing consumers.
