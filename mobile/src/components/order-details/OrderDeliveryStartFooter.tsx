...
export function OrderDeliveryStartFooter({ order, onStart, allowed }: { order: any; onStart?: () => void; allowed: boolean }) {
  ...
  const visible = allowed && !pickup && !started && /agendad|scheduled/.test(status) && onStart;
