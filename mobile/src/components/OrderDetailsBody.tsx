...
interface Props { order: any; isDarkMode: boolean; onStartDelivery?: () => void; onViewDelivery?: () => void }

export function OrderDetailsBody({ order, isDarkMode, onStartDelivery, onViewDelivery }: Props) {
